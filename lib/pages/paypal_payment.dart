import 'package:dailypickings/provider/paypal_services.dart';
...
class _PaypalPaymentScreenState extends State<PaypalPaymentScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      try {
        ...
        final res = await paypalServices.createPaypalPayment(
  ...
  Widget build(BuildContext context) {
    if (checkoutURL != null) {
          ...
          InAppWebView(
            ...
            onLoadStart:
              ...
              if(requestURL.contains(paypalServices.returnURL)) {
                ...
                if(payerId!= null) {
                  await paypalServices.executePayment(executeURL, payerId, accessToken)
                      .then(
                          (id) {
                    print(id);
      ...
      return Scaffold(key: scaffoldKey, appBar: AppBar(
        backgroundColor: Colors.transparent,
        elevation: 0,
        centerTitle: true,
        title: Text(
