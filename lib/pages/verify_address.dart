...
import 'package:dailypickings/pages/payment_screen.dart';
import 'package:dailypickings/provider/cart_provider.dart';
import 'package:dailypickings/utils/form_helper.dart';
               ...
               children: [
                ...
                children: [
                    Flexible(
                      fit: FlexFit.tight,
                      flex: 1,
                       child: FormHelper.fieldLabelValue(context, model.shipping.country),
                  ),
                    Flexible(
                       fit: FlexFit.tight,
                        flex: 1,
                         child: Padding(padding: EdgeInsets.all(5),
                          child: FormHelper.fieldLabelValue(context, model.shipping.state),
                       )
                    )
                   ],
                ),
                 Row(
                  ...
                  children: [
                     Flexible(
                      fit: FlexFit.tight,
                      flex: 1,
                       child: FormHelper.fieldLabelValue(context, model.shipping.city),
                   ),
                        Flexible(
                        fit: FlexFit.tight,
                         flex: 1,
                         child: Padding(padding: EdgeInsets.all(5),
                           child: FormHelper.fieldLabelValue(context, model.shipping.postcode),
                         )
                     )
                   ],
                 ),
                 SizedBox(height: 20),
                 new Center(child: FormHelper.saveButton("Next", (){
