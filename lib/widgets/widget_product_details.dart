...
import 'package:dailypickings/utils/expand_text.dart';
import 'package:dailypickings/widgets/widget_related_products.dart';
                ...
                Visibility(
                  ...
                  child: Align(
                    ...
                    child: Container(
                      ...
                      child: Text('${data.calculateDiscount()}% OFF', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                    ),
                  ),
                ),
                SizedBox(height: 5),
                ...
                Row(
                  ...
                  children: [
                    ...
                    Visibility(
                      visible: data.type == "variable",
                      child:
                      selectDropdown(context, "", this.variableProducts,
